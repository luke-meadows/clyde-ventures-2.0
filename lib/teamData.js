import PaulImage from '../public/team-photos/paul.webp';
import RossImage from '../public/team-photos/ross.webp';
import JoshImage from '../public/team-photos/josh.webp';
import AmberImage from '../public/team-photos/amber.webp';
import LeanneImage from '../public/team-photos/leanne.webp';
import DaveImage from '../public/team-photos/dave.png';
import GrahamImage from '../public/team-photos/graham.png';
export const teamData = {
  ...
  joshMontgomery: {
    ...
    image: JoshImage,
    description: [
      'Josh is happiest when getting into the detail of a complex problem, equally at home in a large data set searching for insight, a detailed commercial negotiation or exploring industry frameworks and regulations.',
      'His last role prior to Clyde Ventures was as Trading Director for a challenger energy supplier, responsible for trading relationships, customer demand forecasting and pricing. In addition he provided analytical support right across the business, including pricing, customer billing, financial forecasting and strategy and regulatory compliance.',
      '​A passionate outdoor enthusiast, his hobbies range from winter mountaineering to canoeing but will happily engage in any activity that gets him out of the house.',
    ],
    linkedIn: 'https://www.linkedin.com/in/josh-montgomery-203663111/',
  },
  amberMorton: {
    name: 'Amber Morton',
